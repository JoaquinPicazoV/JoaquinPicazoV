...
- 🛡️ **Writeups de simulaciones de SOC**  Análisis y resolución de incidentes (Writeups) en entornos SOC simulados (LetsDefend, TryHackMe), utilizando SIEM (Splunk, Elastic) y herramientas de análisis como ANY.RUN, Whois, AbuseIPDB, VirusTotal, CyberChef, entre otros.
